...
// 회사 직원 목록 조회
router.get('/:companyId/members', authMiddleware, companiesController.getComapanyMembers);
// 회사 직원 추가 (초대/직접 등록)
router.post('/:companyId/memebers', authMiddleware, companiesController.addCompanyMember);
// 회사 직원 승인 처리 
router.patch('/:companyId/members/:userId/approve', authMiddleware, conpamiesController.approveCompanyMember);
// 회사 직원 삭제/탈퇴 
